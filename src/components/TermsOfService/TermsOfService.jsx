          ...
          <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            <div className="mx-auto mb-7 inline-block">
              <img
                ...
                alt="Intellectual"
                // Optional: viewBox, fill, and other attributes
              />
            </div>
            <div>
          ...
          <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            <div className="mx-auto mb-7 inline-block">
              ...
              >
                ...
                <path d="M31 10.5H26V8.5H31V10.5Z" fill="#6A64F1"></path>
                <path d="M31 47H26V45H31V47Z" fill="#ABA8F7"></path>
                <path d="M14 28L14 33L12 33L12 28L14 28Z" fill="#6A64F1"></path>
                <defs>
